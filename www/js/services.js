...
.factory('Courses', function() {
  ...
  var coursEN = '{ 	"titre": "Comparative and Superlative Adjectives", 	"audioURL": "", 	"imgURL": "", 	"lesson": [ 			{ 				"texte": "Comparative adjectives are used to compare two things or people to each other.", 				"exemple": [ 						{"1": "A bus is bigger than a car."}, 						{"2": "Bill is older than Harry."} 				] 			} 	] }';
